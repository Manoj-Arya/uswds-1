        ...
        <section class="usa-section grid-container">
            <div class="grid-row grid-gap-4">
                <div class="tablet:grid-col-4">
                    <h2 class="font-heading-xl text-black">
                ...
                <div class="tablet:grid-col-8">
                    <ul class="usa-collection">
                        <li class="usa-collection__item margin-left-2 margin-right-2">
                            <div class="usa-collection__body">
                                <h4 class="usa-collection__heading">
                                    <a
                                        class="usa-link font-heading-lg text-no-underline"
                                        href="#">Software Developer</a>
                                </h4>
                                ...
                                <!-- <p class="usa-collection__description text-gray-70">
