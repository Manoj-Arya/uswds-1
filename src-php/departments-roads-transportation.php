...
<head>
    ...
    <title>Roads and Transportation - RFPMart + USWDS</title>
    <meta name="description" content="Get updates on street projects, traffic conditions, transit options, and city transportation services." />
...
<body>
    ...
    <main id="main-content">
        <section class="usa-hero bg-primary-lighter" style="background-image: url('images/webp/bg-roads-transportation.webp');" aria-label="Introduction">
                        ...
                        <div class="usa-card__container flex-column flex-align-center flex-justify-center hover:shadow-4">
                            ...
                            <div class="usa-card__body">
                                <p class="text-italic text-bold text-base margin-top-0 margin-bottom-0 margin-left-2 flex-wrap">
                                    Provide reliable buses and routes for accessible city travel.
                                </p>
                            </div>
                        </div>
                    </a>
                ...
                <li class="usa-card tablet:grid-col">
                    <a class="usa-link text-no-underline" href="#">
                        <div class="usa-card__container flex-column flex-align-center flex-justify-center hover:shadow-4">
                            ...
                            <div class="usa-card__header">
                                <h3 class="usa-card__heading">
                                    <span>Maintain Roads & Highways</span>
                                </h3>
                            </div>
                            <div class="usa-card__body">
                                <p class="text-italic text-bold text-base margin-top-0 margin-bottom-0 margin-left-2 flex-wrap">
                                    Repair and maintain streets to keep travel safe and smooth.
                                </p>
                            </div>
                        </div>
                    </a>
                ...
                <li class="usa-card tablet:grid-col">
                    <a class="usa-link text-no-underline" href="#">
                        <div class="usa-card__container flex-column flex-align-center flex-justify-center hover:shadow-4">
                            ...
                            <div class="usa-card__header">
                                <h3 class="usa-card__heading">
                                    <span>Traffic Planning & Engineering</span>
                                </h3>
                            </div>
                            <div class="usa-card__body">
                                <p class="text-italic text-bold text-base margin-top-0 margin-bottom-0 margin-left-2 flex-wrap">
                                    Improve traffic flow and roadway safety through planning and design.
                                </p>
                            </div>
                        </div>
                    </a>
                ...
                <li class="usa-card tablet:grid-col">
                    <a class="usa-link text-no-underline" href="#">
                        <div class="usa-card__container flex-column flex-align-center flex-justify-center hover:shadow-4">
                            ...
                            <div class="usa-card__header">
                                <h3 class="usa-card__heading">
                                    <span>Bicycle & Pedestrian Planning</span>
                                </h3>
                            </div>
                            <div class="usa-card__body">
                                <p class="text-italic text-bold text-base margin-top-0 margin-bottom-0 margin-left-2 flex-wrap">
                                    Create safe bike lanes and walking routes for all residents.
                                </p>
                            </div>
                        </div>
                    </a>
                ...
                <li class="usa-card tablet:grid-col">
                    <a class="usa-link text-no-underline" href="#">
                        <div class="usa-card__container flex-column flex-align-center flex-justify-center hover:shadow-4">
                            ...
                            <div class="usa-card__header">
                                <h3 class="usa-card__heading">
                                    <span>Parking & Mobility Services</span>
                                </h3>
                            </div>
                            <div class="usa-card__body">
                                <p class="text-italic text-bold text-base margin-top-0 margin-bottom-0 margin-left-2 flex-wrap">
                                    Oversee parking, permits, and mobility options around the city.
                                </p>
                            </div>
                        </div>
                    </a>
                ...
                <li class="usa-card tablet:grid-col">
                    <a class="usa-link text-no-underline" href="#">
                        <div class="usa-card__container flex-column flex-align-center flex-justify-center hover:shadow-4">
                            ...
                            <div class="usa-card__header">
                                <h3 class="usa-card__heading">
                                    <span>Permits & Street Closures</span>
                                </h3>
                            </div>
                            <div class="usa-card__body">
                                <p class="text-italic text-bold text-base margin-top-0 margin-bottom-0 margin-left-2 flex-wrap">
