...
<head>
    ...
    <meta name="description" content="Explore upcoming city events displayed in a visual gallery for easy browsing." />
    ...
    <main id="main-content">
        ...
        <section class="usa-section grid-container">
            <ul class="usa-card-group grid-row grid-gap-1">
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="family">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="arts_culture">
                    <div class="usa-card__container">
                        <div class="padding-x-3 padding-top-3">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="community">
                    <div class="usa-card__container">
                        <div class="padding-x-3 padding-top-3">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="food_drink">
                    <div class="usa-card__container">
                        <div class="padding-x-3 padding-top-3">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="sports_recreation">
                    <div class="usa-card__container">
                        <div class="padding-x-3 padding-top-3">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="entertainment">
                    <div class="usa-card__container">
                        <div class="padding-x-3 padding-top-3">
