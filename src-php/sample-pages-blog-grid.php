...
<head>
    ...
    <meta name="description" content="Browse city news and updates presented in a visual gallery format for easy exploration." />
...
<body>
    ...
    <main id="main-content">
        ...
        <section class="usa-section grid-container border-bottom-2px border-base-lighter">
        ...
        <div class="usa-section grid-container">
            <ul class="usa-card-group grid-row grid-gap-1">
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="development">
                    <div class="usa-card__container">
                        <div class="display-flex flex-column flex-align-start padding-x-3 padding-top-3">
                            <span class="font-body-xs text-base margin-0">
                                March 12, 2025
                            </span>
                            <span class="usa-tag bg-accent-warm radius-pill margin-top-1">Development</span>
                        </div>
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="health">
                    <div class="usa-card__container">
                        <div class="display-flex flex-column flex-align-start padding-x-3 padding-top-3">
                            <span class="font-body-xs text-base margin-0">
                                March 10, 2025
                            </span>
                            <span class="usa-tag bg-accent-cool-dark radius-pill margin-top-1">Health</span>
                        </div>
                        <div class="usa-card__header">
                            <h4 class="usa-card__heading">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="transportation">
                    <div class="usa-card__container">
                        <div class="display-flex flex-column flex-align-start padding-x-3 padding-top-3">
                            <span class="font-body-xs text-base margin-0">
                                March 8, 2025
                            </span>
                            <span class="usa-tag bg-primary-dark radius-pill margin-top-1">Transportation</span>
                        </div>
                        <div class="usa-card__header">
                            <h4 class="usa-card__heading">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="safety">
                    <div class="usa-card__container">
                        <div class="display-flex flex-column flex-align-start padding-x-3 padding-top-3">
                            <span class="font-body-xs text-base margin-0">
                                March 5, 2025
                            </span>
                            <span class="usa-tag bg-secondary-dark radius-pill margin-top-1">Safety</span>
                        </div>
                        <div class="usa-card__header">
                            <h4 class="usa-card__heading">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="outdoors">
                    <div class="usa-card__container">
                        <div class="display-flex flex-column flex-align-start padding-x-3 padding-top-3">
                            <span class="font-body-xs text-base margin-0">
                                March 2, 2025
                            </span>
                            <span class="usa-tag bg-accent-warm-darker radius-pill margin-top-1">Outdoors</span>
                        </div>
                        <div class="usa-card__header">
                            <h4 class="usa-card__heading">
                ...
                <li class="usa-card tablet:grid-col-6 desktop:grid-col-4" data-category="city council">
                    <div class="usa-card__container">
                        <div class="display-flex flex-column flex-align-start padding-x-3 padding-top-3">
                            <span class="font-body-xs text-base margin-0">
                                February 28 , 2025
                            </span>
                            <span class="usa-tag bg-primary radius-pill margin-top-1">City Council</span>
                        </div>
                        <div class="usa-card__header">
                            <h4 class="usa-card__heading">
